...
rec_all <- data.frame(rbind(rec_train, rec_test), row.names = c('Train', 'Test'))

write.csv(rec_all, file = 'res_radiomics.csv')
...
rec_all <- data.frame(rbind(rec_train_cli, rec_test_cli), row.names = c('Train', 'Test'))
write.csv(rec_all, file = 'res_clinics.csv')
